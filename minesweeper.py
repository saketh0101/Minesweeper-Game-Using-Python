...
class Board:
    def __init__(self, dim_size, num_bombs):
        #let's keep the track of these parameters. they'll be helpful later
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            ...
            if board[row][col] == '*':
                # this means we actually planted a bomb there already so keep going
                continue
    ...
    def get_num_neighboring_bombs(self, row, col):
        # lets iterate through each of the neighboring positions an dsum number of bombs
    ...
    def dig(self, row, col):
        ...
        # dig at location with no neighboring bombs -> recursively dig neigbors!
...
def play(dim_size=10, num_bombs=10):
    ...
    #Step-2: show the user the board and ask for where thay want to dig
